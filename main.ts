...
function saySomething (hello: string) {
    Spaceship.sayText("FASTER! FASTER!")
}
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    while (info.life() > 1) {
        bullets = sprites.createProjectileFromSprite(img`
            ...
            . . . . . 2 2 2 2 2 2 . . . . . 
            `, Spaceship, 0, -50)
        Spaceship.sayText("Go get stars!")
        pause(200)
    }
})
function saySomething2 (sprite: string) {
...
controller.combos.attachCombo("BBA", function () {
    controller.moveSprite(Spaceship, 300, 300)
    saySomething("FASTER! FASTER!")
})
...
let userName = ""
userName = game.askForString("What is your name?", 12)
let welcome = saySomething2("Welcome to the game, " + userName)
game.splash(welcome)
...
Spaceship = sprites.create(img`
    ...
    ....ff6666666f66f6666666ff......
    ....f66666666ffff66666666f......
    ....f6ffff6666666666ffff6f......
    ....f66666f66666666f66666f......
    ....f6fffff66ffff66fffff6f......
    ...ff6f...f66f..f66f...f6ff.....
    ...f6ff...ffff..ffff...ff6f.....
    ...fff....5225..5225....fff.....
    ..........5225..5225............
    ...
    ................................
    `, SpriteKind.Player)
Spaceship.sayText("Hello captain " + userName, 3000, true)
info.setLife(3)
...
game.onUpdateInterval(2000, function () {
    ...
    if (info.life() > 50) {
        gasTank.setFlag(SpriteFlag.AutoDestroy, true)
    }
})
